...
public class SubirseHamaca : MonoBehaviour
{
    [Header("UI")]
    ...
    private void Subir()
    {
        ...
        // Dialogo
        if (subtitleController != null && dialogueHamaca != null)
    ...
    private System.Collections.IEnumerator EsperarFinAnimacion()
    {
        ...
        float duracion = hamacaAnimator.GetCurrentAnimatorStateInfo(0).length;
    ...
    private void Bajar()
    {
        ...
        Debug.Log("Hamaca: used = " + used + " | eImage apagada");
    }
}