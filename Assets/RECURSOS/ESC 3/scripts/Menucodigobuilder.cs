...
public class MenuCodigoBuilder : MonoBehaviour
{
#if UNITY_EDITOR
    [ContextMenu("Construir Menu Codigo")]
    void ConstruirMenu()
    {
        // Canvas
        GameObject canvasGO = new GameObject("MenuCodigoCanvas");
        ...
        tmpPreg.text = "¿Qué era todo esto, en verdad?";
        tmpPreg.fontSize = 34;
        ...
        // Texto ingresado (lo que el jugador escribe)
        ...
        // Flash blanco (para la transicion final)
        GameObject flash = new GameObject("FlashBlanco");
        ...
        Undo.RegisterCreatedObjectUndo(canvasGO, "Construir Menu Codigo");
        Debug.Log("Menu codigo construido. Asigná los campos al script MenuCodigo.");
    }
#endif
}